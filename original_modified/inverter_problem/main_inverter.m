...
lx = 2.0; %Length of x
ly = 1.0; %Length of y
nelx = 200; %Discritization number of x
...
lag = 1.0; %Lagrange multiplier for volume constraint
n_target_disp_in = (nelx+1)*1; % The Node applying the target displacement
n_target_disp_out = (nelx+1) * (nely+1 - 1) + 1;
n_target_disp = [n_target_disp_in n_target_disp_out];
u_target_out = 11;
...
phaseField_inverter(h,nelx,nely,e,nu,lv,lag,kappa,eta,wcoef,PDECycle,timeStep,u_target_out);